...
class Babelstream(SpackApplication):
    ...
    executable('get_bin_fortran',
               template=['export F_COMPILER_NAME={compiler_list}; cp {env_path}/.spack-env/view/bin/BabelStream.${F_COMPILER_NAME//[0-9]/}.{f_model} {experiment_run_dir}/{exec_name}'],
               use_mpi=False, output_capture=OUTPUT_CAPTURE.STDERR)
